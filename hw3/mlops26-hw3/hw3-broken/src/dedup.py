...
частей текста. Нужны обе: на этом источнике точная снимает 7 102 строки
(источник склеен из трёх выгрузок, и тикеты повторяются на их стыке), near-dup
добирает ещё 20 переписанных друг с друга писем. Какая из двух найдёт больше,
заранее неизвестно — на курсовом датасете соотношение было обратным.
"""
